...
public class TutorialFishController : MonoBehaviour
{
    public static TutorialFishController Instance { get; private set; }
    ...
    // Event to notify when tutorial is closed
    ...
    {
        tutorialPanel.SetActive(false);
        onTutorialClosed?.Invoke(); // Notify listeners
    }
